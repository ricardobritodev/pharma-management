...
INSERT INTO movimentacoes (produtos_fk, tipo, quantidade, data, responsavel, fk_usuarios_id) VALUES
(1, 'Entrada', 100, '2024-03-15', 'João Silva Pereira', 1),
(2, 'Saída', 50, '2024-03-16', 'Maria Oliveira Santos', 2),
(3, 'Ajuste de Estoque', 30, '2024-03-17', 'Carlos Eduardo Souza', 3),
(5, 'Entrada', 200, '2024-03-18', 'Ana Clara Fernandes', 4),
(7, 'Saída', 75, '2024-03-19', 'Pedro Henrique Alves', 5),
(4, 'Devolução', 25, '2024-03-20', 'Juliana Costa Lima', 6),
(9, 'Entrada', 150, '2024-03-21', 'Lucas Martins Rocha', 7),
(6, 'Saída', 90, '2024-03-22', 'Fernanda Gomes Castro', 8),
(8, 'Transferência', 60, '2024-03-23', 'Rafael Pereira Nunes', 9),
(10, 'Ajuste de Estoque', 10, '2024-03-24', 'Amanda Ribeiro Teixeira', 10);
